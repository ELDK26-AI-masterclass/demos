...
const resolveInitialTheme = (): ThemeMode => {
  try {
    ...
    // Ignore storage failures and use system preference fallback.
  }
...
function App() {
  ...
  useEffect(() => {
    try {
      ...
      // Ignore persistence failures and keep runtime theme state.
    }
  }, [themeMode])
    ...
    <div className="app-container">
      <header className="app-header">
        <div className="theme-switch-wrapper">
          <label htmlFor="theme-toggle" className="theme-switch-label">Dark mode</label>
          <input
            id="theme-toggle"
